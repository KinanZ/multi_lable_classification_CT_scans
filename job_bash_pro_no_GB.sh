#PBS -N supervised_MLC_pro_no_GB
#PBS -S /bin/bash
...
python3 /misc/student/alzouabk/Thesis/supervised_multi_label_classification/src/train_pro_no_GB.py -cp '/misc/student/alzouabk/Thesis/supervised_multi_label_classification/configs/config_stack_pro_no_GB.yml'
