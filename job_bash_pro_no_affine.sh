#PBS -N supervised_MLC_pro_no_Affine
#PBS -S /bin/bash
...
python3 /misc/student/alzouabk/Thesis/supervised_multi_label_classification/src/train_pro_no_Affine.py -cp '/misc/student/alzouabk/Thesis/supervised_multi_label_classification/configs/config_stack_pro_no_Affine.yml'
