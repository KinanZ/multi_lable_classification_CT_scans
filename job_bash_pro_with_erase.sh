#PBS -N supervised_MLC_pro_with_erase
#PBS -S /bin/bash
...
python3 /misc/student/alzouabk/Thesis/supervised_multi_label_classification/src/train_pro_with_erase.py -cp '/misc/student/alzouabk/Thesis/supervised_multi_label_classification/configs/config_stack_pro_with_erase.yml'
