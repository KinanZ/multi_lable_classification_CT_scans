#PBS -N supervised_MLC_default_aug_3_channel
#PBS -S /bin/bash
...
python3 /misc/student/alzouabk/Thesis/supervised_multi_label_classification/src/train_aug_exp.py -cp '/misc/student/alzouabk/Thesis/supervised_multi_label_classification/configs/config_stack_slices.yml'
