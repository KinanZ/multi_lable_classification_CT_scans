#PBS -N supervised_MLC_affine_m_ED_s
#PBS -S /bin/bash
...
python3 /misc/student/alzouabk/Thesis/supervised_multi_label_classification/src/train_aug_exp.py -cp '/misc/student/alzouabk/Thesis/supervised_multi_label_classification/configs/config_stack_slices_affine_m_ED_s.yml'
