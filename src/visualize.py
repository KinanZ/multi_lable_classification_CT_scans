...
def plot_evaluation_metrics(eval_results, output_path):
    ...
    plt.plot(eval_results['sample/precision'], color='yellow', label='sample/precision')
    plt.xlabel('Epochs')
    ...
    plt.plot(eval_results['sample/recall'], color='yellow', label='sample/recall')
    plt.xlabel('Epochs')
    plt.ylabel('Recall')
    plt.legend()
    ...
    plt.plot(eval_results['sample/f1'], color='yellow', label='sample/f1')
    plt.xlabel('Epochs')
    plt.ylabel('F1_score')
    plt.legend()
